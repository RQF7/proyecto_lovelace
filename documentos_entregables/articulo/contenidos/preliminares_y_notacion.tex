...
\mathcal{M} \times \mathcal{K} \rightarrow \mathcal{C} $, donde $ \mathcal{M} $
es el espacio de textos en claro, $ \mathcal{K} $ el espacio de llaves y $
\mathcal{C} $ el espacio de mensajes cifrados. Tanto los mensajes en claro
