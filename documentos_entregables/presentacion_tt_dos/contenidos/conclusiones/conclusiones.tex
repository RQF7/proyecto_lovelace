...
\begin{frame}{Sobre los objetivos}
  ...
  \begin{itemize}
    ...
    \item<2-> Diseñar e implementar un servicio web que proporcione la
...
\begin{frame}{Sobre los algoritmos}
  \begin{itemize}
    \item<1-> La \emph{detokenización} es más rápida que la generación de
...
\begin{frame}{Sobre la clasificación}
  ...
  los algoritmos tokenizadores en respuesta a la clasificación propuesta
  por el PCI.
  \begin{itemize}
...
\begin{frame}{Sobre el trabajo desarrollado}
  \begin{itemize}
    ...
    \item Tanto el servicio tokenizador como la tienda en línea pueden ser
      consultadas en las siguientes direcciones [direccion_servicio,
      direccion_tienda]
  \end{itemize}
\end{frame}
