...
\
\begin{frame}{Protección de datos bancarios}
...
\begin{frame}{Protección de datos bancarios}
  \begin{itemize}
    \item<1-> En el 2004 se publicó el PCI DSS\footnotemark \cite{pci_dss}.
      \note<1>{
    ...
    \item<3-> A pesar de la publicación del estándar, las filtraciones de datos
      no han cesado.
      \note<3>{
        Recalcar que ni el estándar ni la tokenización son la panacea,
        filtraciones como las de HomeDepot y Target continúan.}
    \item<4-> En 2011, el PCI SSC\footnotemark{} publicó las primeras guías
