%
% Diagrama de red Feistel alternante,
...
\begin{tikzpicture}[
  ...
  nodo/.style = {
    ...
    \draw[-]
      ...
      --
      ($(izquierda_cero.north)!0.5!(derecha_cero.north) + (-5mm, 0mm)$);
    ...
    \draw[-Stealth]
      ...
      (derecha_dos.north);
    \draw[-Stealth]
      (funcion_uno.west -| izquierda_uno.south)
      --
      (izquierda_dos.north);
    ...
    \draw[-]
      ($(izquierda_n.south)!0.5!(derecha_n.south) + (-5mm, 0mm)$)
      --
