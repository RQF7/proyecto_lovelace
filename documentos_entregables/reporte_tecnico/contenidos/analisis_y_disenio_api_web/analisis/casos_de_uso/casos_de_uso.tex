...
\begin{longtable}{| m{4.6in} | m{2.0in} |}
  ...
  \hipervinculo{rq:recordatorio_refresco}                 & \\\cline{1-1}
  ...
  \hipervinculo{rq:mostrar_clientes_vetados}              & \\\hline
  ...
  \hipervinculo{rq:estados_tokens}                      & \\\cline{1-1}
  \hipervinculo{rq:estados_llaves}                      & \\\cline{1-1}
  \hipervinculo{rq:estados_clientes}                    & \\\hline
  ...
  \hipervinculo{rq:estados_clientes}                    & \\\cline{1-1}
  \hipervinculo{rq:confirmar_cliente}                   & \\\hline
  ...
  \hipervinculo{rq:estados_tokens}                      & \\\hline
