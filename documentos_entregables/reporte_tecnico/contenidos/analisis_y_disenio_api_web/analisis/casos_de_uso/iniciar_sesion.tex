...
%
% TODO:
% * Agregar validaciones de estado de un cliente: los clientes no verificados,
%   verificados o en lista negra no deben poder iniciar sesión (¿esto debe de
%   ir en alguna regla de negocio?).
%
