...
{Estados de un token}
{
  ...
  \begin{hangparas}{2em}{0}
    ...
    llaves, se cambian los tokens \textbf{retokenizados} del cliente a estado
    \textbf{actual}. Estas transiciones se pueden observar en la Figura
    \ref{estados_token}.
  \end{hangparas}
}
...
{Estados de un correo electrónico}
{
  ...
  \begin{hangparas}{2em}{0}
    ...
    validación válido (véase \hipervinculo{rn:verificacion_de_cuentas}). Estas
