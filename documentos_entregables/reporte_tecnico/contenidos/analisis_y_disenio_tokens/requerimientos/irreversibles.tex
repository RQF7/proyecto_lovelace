...
% IT1A
\requerimiento{PCI}{Sobre la generación de \glspl{gl:token} (irreversibles)}
{
  ...
  {PCI}{Sobre el mecanismo generador (irreversibles)}
  {
  ...
  {PCI}{Contenido en claro (irreversibles)}
  {
  ...
  {PCI}{Creación de un diccionario (irreversibles)}
  {
  ...
  {PCI}{Sobre el proceso de autenticación (irreversibles)}
  {
