...
{PCI}{Validación de productos de hardware}
{
...
{PCI}{Validación de productos de software}
{
...
{PCI}{Resistencia a texto claro conocido}
{
...
{PCI}{Resistencia a sólo texto cifrado}
{
...
{PCI}{Distinción entre \glspl{gl:token} y \gls{gl:pan}}
{
...
{PCI}{Integridad del proceso de tokenización}
{
...
{PCI}{Acceso al proceso detokenización}
{
  ...
  {PCI}{\Gls{gl:autenticacion_multifactor}}
  {
  ...
  {PCI}{Accesos a nivel de sistema}
  {
...
{PCI}{Mapeos de \gls{gl:token} a \gls{gl:token} prohibidos}
{
...
{PCI}{Protección contra vulnerabilidades comunes}
{
...
{PCI}{Primitivas criptográficas usadas}
{
...
{PCI}{Sobre el manejo adecuado de llaves}
{
  ...
  {PCI}{Descripción del periodo criptográfico activo}
  {
  ...
  {PCI}{Sobre la destrucción de las llaves}
  {
  ...
  {PCI}{Exportar llave en claro prohibido}
  {
  ...
  {PCI}{Entropía de generación de llaves}
  {
