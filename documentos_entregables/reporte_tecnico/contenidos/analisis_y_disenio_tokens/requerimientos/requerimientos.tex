...
Para un seguimiento posterior, cada requerimiento se clasifica según la
...
propósitos de este trabajo. En la segunda y tercera categorías se agrupan
los requerimientos que, en efecto, un trabajo como este deben de cumplir.
