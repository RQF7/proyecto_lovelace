...
{PCI}{Probabilidad de encontrar un PAN (no criptográficos)}
{
  ...
  {PCI}{Distribución equiprobable (no criptográficos)}
  {
  ...
  {PCI}{Permutaciones aleatorias (no criptográficos)}
  {
  ...
  {PCI}{Parámetros de tokenización (no criptográficos)}
  {
  ...
  {PCI}{Verificación de la aleatoriedad (no criptográficos)}
  {
