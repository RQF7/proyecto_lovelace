...
\requerimiento{PCI}{Probabilidad de adivinar relaciones (criptográficos)}
{
  ...
  {PCI}{Distribución uniforme (criptográficos)}
  {
  ...
  {PCI}{Permutación aleatoria (criptográficos)}
  {
  ...
  {PCI}{Cambio de llave (criptográficos)}
  {
  ...
  {PCI}{Cambio de \gls{gl:pan} (criptográficos)}
  {
  ...
  {PCI}{Verificación de la aleatoriedad (criptográficos)}
  {
...
{PCI}{Almacenamiento de tokens (criptográficos)}
{
...
{PCI}{Seguridad de la administración de llaves (criptográficos)}
{
...
{PCI}{Sobre la longitud de las llaves (criptográficos)}
{
...
{PCI}{Independencia estadística (criptográficos)}
{
