...
{Agregar dirección de entrega}
{
  ...
  \begin{trayectoriaPrincipal}
    ...
    \item[origen] El \textbf{cliente} presiona el botón de
      ...
      \hipervinculo{lib_iu:formulario_informacion_personal} o
      \textit{Nueva dirección} en
      la interfaz \hipervinculo{lib_iu:seleccionar_direccion_de_entrega}.
    ...
    \item[mensaje] El sistema muestra el mensaje
      \hipervinculoLocal{lib_msj:direccion_de_entrega_guardada}
