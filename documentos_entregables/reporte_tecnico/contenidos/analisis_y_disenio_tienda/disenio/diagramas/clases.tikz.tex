...
\begin{tikzpicture}[]
  ...
  \umlcompo[%
    % anchors = 200 and 300]{Negocio TV}{Utilidades}
    % anchors = 220 and 300]{Negocio TV}{Utilidades}
    % anchor2 = 220]{Negocio TV}{Utilidades}
    geometry = |-|, anchor2 = 300, anchor1 = 493.5]{Negocio TV}{Utilidades}
