...
\begin{tikzpicture}[]
  \begin{umlpackage}{Tienda Virtual}
    ...
    \umlcompo[%
      mult1 = 1,
      anchor2 = 34.5]{Direcciones TV}{Operaciones web TV}
    \umlcompo[%
      mult1 = 1,
      anchor1 = -22]{Operaciones web TV}{Negocio TV}
  ...
  \umlcompo[%
    anchors = 150 and 300]{Negocio TV}{Utilidades}
