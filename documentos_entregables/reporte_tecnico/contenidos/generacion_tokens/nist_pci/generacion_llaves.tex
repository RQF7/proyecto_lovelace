...
\subsubsection{Generación de llaves en general}
...
\subsubsection{Modos de iteración}
...
\paragraph{Double pipeline mode}
...
\paragraph{Separación entre llaves}
