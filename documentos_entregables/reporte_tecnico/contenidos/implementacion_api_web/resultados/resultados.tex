...
\subsection{Desempeño de la \texorpdfstring{\acrshort{gl:api}}{FFX}}
...
\begin{table}
  \begin{center}
    \begin{tabular}{c|c|c|}
      ...
      \hline
      \multicolumn{1}{|c|}{\texorpdfstring{\acrshort{gl:ffx}}{FFX}}
        & 206.526 s & 208.204 s \\\hline
      \multicolumn{1}{|c|}{\texorpdfstring{\acrshort{gl:bps}}{BPS}}
        & 219.036 s & 219.448 s \\\hline
      \multicolumn{1}{|c|}{TKR}
        & 824.969 s & 103.854 s \\\hline
      \multicolumn{1}{|c|}{AHR}
        & 436.053 s & 132.297 s \\\hline
      \multicolumn{1}{|c|}{\texorpdfstring{\acrshort{gl:drbg}}{DRBG}}
