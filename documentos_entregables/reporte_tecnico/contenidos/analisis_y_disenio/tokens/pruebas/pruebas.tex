...
La salida de los \gls{gl:prng}s normalmente son funciones determinísticas de 
...
\texit{pseudoaleatorio} y lo que causa la necesidad de mantener en secreto 
la \gls{gl:semilla}.
...
nula \texit{(H0)}, o la hipótesis alternativa \textit{(Ha)}, las cuales dicen 
...
\texit{nivel de significancia} de la prueba, y se denota como $\alpha$, este 
