...
\newglossaryentry{gl:cifrado_iterativo}
{
  ...
  description = {
    ...
    una función interna llamada función de ronda. Los
...
\newglossaryentry{gl:primitiva_criptografica}
{
  ...
  description = {
    ...
    construcción de protocolos de seguridad. En \cite{menezes}
...
\newglossaryentry{gl:oraculo}
{
  ...
  description = {
    ...
    (llamada \textit{oráculo}) que puede resolver ciertos problemas de
