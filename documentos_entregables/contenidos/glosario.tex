...
\newglossaryentry{gl:computacionalmente_indistinguible}
{
  name = computacionalmente indistinguible,
  % esto se puso para ya tener la liga al glosario.
  description = {En investigación% no entiendo bien las definiciones 
  }
}
