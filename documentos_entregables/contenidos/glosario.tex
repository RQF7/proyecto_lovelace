...
\newglossaryentry{gl:cifrado_iterativo}
{
  ...
  description = {
    ...
    repetición secuencial de una función interna llamada función de
    \gls{gl:ronda}. Los parámetros incluyen en número de rondas, el tamaño de
    bloque y el tamaño de llave%
  },
...
\newglossaryentry{gl:primitiva_criptografica}
{
  ...
  description = {
    ...
    con frecuencia para la construcción de protocolos de seguridad.
    En~\cite{menezes} se clasifican en tres categorías principales: de llave
...
\newglossaryentry{gl:oraculo}
{
  ...
  description = {
    ...
    una caja negra (llamada oráculo) que puede resolver ciertos problemas de
    decisión u obtener el valor de una función en una sola operación%
  },
