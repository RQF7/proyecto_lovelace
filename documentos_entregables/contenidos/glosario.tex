...
\newglossaryentry{gl:tiempo_polinomial}
{
  ...
  description = {
    ...
    polinomial} cuando su complejidad esta, en el peor de los casos, acotada 
    por arriba por un polinomio sobre el tamaño de sus variables de entrada.
    Si se toma a $f$ como una función computable, está es de tiempo polinomial 
    si $f\: \in\: O(n^k)$ donde $k \ge 1$%
  }
}
