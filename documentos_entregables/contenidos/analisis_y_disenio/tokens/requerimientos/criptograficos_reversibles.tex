...
\begin{itemize}
  ...
  % RC4B Prácticas para la administración de llaves
  ...
  \begin{itemize}
    ...
    % RC4B2 Descripción de periodos para cada llave.
    \item La política de la vida útil de cada llave debe incluir una
      descripción del periodo activo.

    % RC4B3 Permitir la destrucción de todas las llaves.
  ...
  % RC4D Independencia estadística.
