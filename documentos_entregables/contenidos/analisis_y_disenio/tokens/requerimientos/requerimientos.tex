...
\requerimiento[rq:productos]{Productos de hardware}
{
...
% Ver requerimeintos \hipervinculo{rq:productos} y \hipervinculo{rq:02}; y
% subrequerimientos \hipervinculo{rq:cripto:ciclo_de_vida} y
% \hipervinculo{rq:15_3}
