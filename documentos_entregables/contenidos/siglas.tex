...
\newacronym{gl:cavp}{CAVP}{Cryptographic Algorithm Validation Program}
...
\newacronym[type=siglas_cripto]{gl:cmac}{CMAC}{cipher-based Message Authentication Code}

\newacronym{gl:nvlap}{NVLAP}{National Voluntary Laboratory Accreditation Program}
