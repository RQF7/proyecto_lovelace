...
\newacronym{gl:rbacs}{RBACs}{\textit{Role-Based Access Controls}}

\newacronym{gl:fpe}{FPE}{\textit{Format Preserving Encryption}}

\newacronym{gl:trng}{TRNG}{\textit{True Random Number Generator}}
