...
\newacronym[type=siglas_cripto]{gl:bps}{BPS}{Brier-Peyrin-Stern}
...
\newacronym[type=siglas_cripto]{gl:cmac}{CMAC}
  {Cipher-based \acrshort{gl:mac}}

\newacronym[type=siglas_cripto]{gl:cmc}{CMC}{%
  \acrshort{gl:cbc}-Mask-\acrshort{gl:cbc}}
...
\newacronym[type=siglas_cripto]{gl:dhe}{DHE}{\acrshort{gl:dh} Ephemeral}
...
\newacronym[type=siglas_cripto]{gl:ecdh}{ECDH}{Elliptic Curve \acrshort{gl:dh}}

\newacronym[type=siglas_cripto]{gl:ecdsa}{ECDSA}{%
  Elliptic Curve \acrshort{gl:dsa}}
...
\newacronym[type=siglas_cripto]{gl:eme}{EME}{%
  \acrshort{gl:ecb}-Mask-\acrshort{gl:ecb}}
...
\newacronym[type=siglas_cripto]{gl:hctr}{HCTR}{Hash \acrshort{gl:ctr}}
...
\newacronym[type=siglas_cripto]{gl:nmac}{NMAC}{Nested \acrshort{gl:mac}}
...
\newacronym[type=siglas_cripto]{gl:omac}{OMAC}{One-key \acrshort{gl:mac}}

\newacronym[type=siglas_cripto]{gl:owhf}{OWHF}{One-Way Hash Function}

\newacronym[type=siglas_cripto]{gl:pmac}{PMAC}{Parallel \acrshort{gl:mac}}
...
\newacronym[type=siglas_cripto]{gl:rha}{RHA}{Reversible Hybrid Algorithm}
...
\newacronym[type=siglas_cripto]{gl:rsaes}{RSAES}
  {\acrshort{gl:rsa} Encryption Scheme}
...
\newacronym[type=siglas_cripto]{gl:tdes}{TDES}{Triple \acrshort{gl:des}}
...
\newacronym[type=siglas_cripto]{gl:uto}{UTO}{Updatable Tokenization}
