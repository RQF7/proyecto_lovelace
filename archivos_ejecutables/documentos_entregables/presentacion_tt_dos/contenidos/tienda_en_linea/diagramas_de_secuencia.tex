...
\begin{frame}{Diagramas de secuencia}{Caso de uso: compra}

  \begin{figure}
    \begin{center}
      \subimport{diagramas/}{secuencia_comprar.tikz.tex}
      \caption{Diagrama de secuencia del caso de uso de compra.}
    \end{center}
  \end{figure}
...
\begin{frame}{Diagramas de secuencia}{Caso de uso: compra - obtención de datos}

  \begin{figure}
    \begin{center}
      \subimport{diagramas/}{secuencia_comprar_p1.tikz.tex}
      \caption{Acercamiento del diagrama de secuencia: obtención de datos.}
      % \caption{Fragmento de obtención de datos del diagrama de secuencia
      %   del caso de uso de compra.}
    \end{center}
  \end{figure}
...
\begin{frame}{Diagramas de secuencia}
  {Caso de uso: compra - finalización de compra}

  \begin{figure}
    \begin{center}
      \subimport{diagramas/}{secuencia_comprar_p2.tikz.tex}
      \caption{Acercamiento del diagrama de secuencia: interacción con el
