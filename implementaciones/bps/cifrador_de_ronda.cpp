...
unsigned int CifradorDeRonda::getTamBloque()
{
  return 128;
}
...
/* ========================================================================= */
/**
 * Método para cifrar una cadena con la llave dada, esté utiliza AES de 
...
/* ========================================================================= */
/**
 * Método para descifrar una cadena con la llave dada, esté utiliza AES 
